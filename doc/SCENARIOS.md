...
| 4  | k3d/1.22.6+k3s1 | eks            | etcd:v3.4.16-eks-1-21-8 \                   |
|    |                 |                | kube-controller-manager:v1.21.5-eks-1-21-8 \
|    |                 |                | kube-apiserver:v1.21.5-eks-1-21-8           | yes       | yes     | only objects | [eks-v121](../scenarios/argo/fakeimages/k3s/vcluster-eks-121.yaml)|
